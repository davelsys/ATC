...
Partial Class OrderSummary
    ...
    Private Sub BindOrderSummaryGrid()
        ...
        Else
            ...
            If ddlCarrier.SelectedValue.ToLower = "verizon" Or ddlCarrier.SelectedValue.ToLower = "concord" Or ddlCarrier.SelectedValue.ToLower = "telco" Or ddlCarrier.SelectedValue.ToLower = "vzpp" Then
    ...
    Private Function GetTotalCustomers(Optional ByVal isAjax As Boolean = False) As String
        ...
        cmd.CommandText += "(SELECT '   VZPP: ' + convert(varchar,COUNT(*))  FROM [orders] where carrier_name = 'VZPP') + '<br />' + "
