...
Partial Class Esn
    ...
    Private Sub BindesnvalGrid()
        ...
        sql.Append("(select o.cell_num as [CellNum],  e.Esn as [ppESN],o.Esn  as [OrderESN], Status [Status], DeviceMake [DeviceMake],  DeviceModel, DeviceState,  e.LastModified from ESNValidation e ")
        sql.Append("JOIN orders o ON e.MDN = o.cell_num ")
        sql.Append("join mdn m on o.cell_num = m.phonenumber ")
        sql.Append("WHERE o.monitor = 1 and o.esn != e.esn ")
        sql.Append("union ")
        sql.Append("select o.cell_num, e.Esn as [ppESN],'', Status [Status], DeviceMake, DeviceModel, DeviceState,  e.LastModified from ESNValidation e ")
        sql.Append("join orders o on o.esn= e.Esn ")
        sql.Append("join mdn m on o.cell_num = m.phonenumber ")
        sql.Append("where DeviceState = 'UNKNOWN') ")
        sql.Append("order by e.LastModified desc")
