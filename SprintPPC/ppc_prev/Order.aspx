...
<script language="javascript" type="text/javascript" src="formatScripts.js"></script>
    ...
    <script type="text/javascript">
        ...
        function TogglePayButton() {
            ...
            if ( radioButtons[0].checked ) {      // Credit card selected
                ...
                if (!starredPattern.test(ccNumber) && !regularPattern.test(ccNumber) && document.getElementById("carrierName").value !== "Concord"
                    && document.getElementById("carrierName").value !== "Telco" && document.getElementById("carrierName").value !== "Sprint") {
        ...
        function continueSaveOrder() {
            ...
            if ( newNumberForm.getCarrier() == 'page plus' || newNumberForm.getCarrier() == "vzpp" ) {
                // Require cell number
        ...
        function populatePlanEsnAndPins( xml ) {
            ...
            if (newNumberForm.getCarrier() == 'verizon' || newNumberForm.getCarrier() == 'concord' || newNumberForm.getCarrier() == 'telco' || newNumberForm.getCarrier() == 'sprint') {
  ...
  function isValidDate(str){
        ...
        var newNumberForm = {
            ...
            init: function () {
                ...
                if (this.isNewOrder()) {
                    ...
                    if (this.getCarrier() == 'page plus' || this.getCarrier() == 'vzpp') {
                        
                        this.showPagePlus();
                        if (this.getCarrier() == 'vzpp') {
                            document.getElementById("vzppPlanDatesDiv").style.display = 'block';
                            //document.getElementById("moniterChckBox").style.display = 'none';

                            document.getElementById('dvvzppLoginInfo').style.display = 'block';
                            document.getElementById('dvVendorPin').style.display = 'none';
                            ...
                            ////var day2 = todaydate.getDate();
                            ////var month2 = todaydate.getMonth() + 2;
                            ////var year2 = todaydate.getFullYear();
                            ////var nextdatestring = month2 + "/" + day2 + "/" + year2;

                            //document.getElementById("tbVZPPPlanStart").value = datestring;
                            //document.getElementById("tbVZPPPlanExp").innerHTML  = nextdatestring;
                        } else {
                            document.getElementById('dvvzppLoginInfo').style.display = 'none';
                            document.getElementById('dvVendorPin').style.display = 'block';
                        }
                        
                        //return;
                    } else if (this.getCarrier() == 'verizon' || this.getCarrier() == 'concord' || this.getCarrier() == 'telco' || this.getCarrier() == 'sprint') {
                       ...
                       //alert(vReqType)
                        ...
                        if (verStatus.missingMDN()  && this.getCarrier() != 'sprint') {
                                this.initVerReq();
            ...
            toggleCarrier: function (self) {
               ...
               // alert(self.getCarrier())
               
                var msg = '';
                if (carrier == 'verizon' || carrier == 'concord' || carrier == 'telco' || carrier == 'sprint') {
                    ...
                    self.showVerizon();
                } else if (carrier == 'page plus' || carrier == 'vzpp') { //|| (carrier == 'all talk')) { sg 07/13/16 removing all talk
        ...
        var planDropdowns = {
            toggle: function () { 
                var state = document.getElementById('cell_number').value.length != 10 && document.getElementById("carrierName").value != 'Concord' && document.getElementById("carrierName").value != 'Telco' & document.getElementById("carrierName").value != 'Sprint';
        ...
        function dateChanged(calendar) {
               ...
               if (calendar.eventName == "sd") {
                   document.getElementById("tbVZPPPlanStart").value = m + 1 + "/" + d + "/" + y;
                   //setExpDate()
                   return;
               }
               //if (calendar.eventName == "ed") {
               //    document.getElementById("tbVZPPPlanExp").value = m + 1 + "/" + d + "/" + y;
               //    return;
               //}
...
<%--                <asp:Button ID="statusBtn" runat="server" Height="12px" 
            ...
            <span class="statusBlock">
                <span id="displayCashBalance" runat="server">
                <label>Balance:</label>
                            ...
                            <div id="phoneInfoDiv" class="orderFields" 
                                ...
                                <div class="phoneFieldsHeight">
                                    ...
                                    <div class="leftPhoneFields">
                                        ...
                                        <asp:DropDownList ID="carrierName" runat="server" AutoPostBack="false" Width="105px" >
                                    ...
                                    <div id="readOnlyCellDiv" style="display: none;" runat="server" class="rightPhoneFields verizonComponent">
                                        ...
                                        <asp:TextBox ID="txtCellNum" runat=server Visible="false"></asp:TextBox>
                                    </div>
                                ...
                                <div class="phoneFieldsHeight" style="display: none;" id="vzppPlanDatesDiv" runat="server">
                                            <div id="Div2" runat="server" class="leftPhoneFields">
                                                <label class="orderLabel">Exp Date:</label>
                                                <asp:TextBox ID="tbVZPPPlanStart" runat="server" Width="90px" ></asp:TextBox><%--onchange="setExpDate()"--%>
                                                <asp:Button ID="showCalendarSD" runat="server" Class="btnCalendar" onClientClick="return false;"/>
                                            </div>
                                                <%--<div id="Div1" runat="server" class="rightPhoneFields" >
                                                    <label class="orderLabel">Exp Date:</label>
                                                    <asp:Label ID="tbVZPPPlanExp" runat="server"></asp:Label>--%>
                                                    
                                                    <%--<asp:TextBox ID="tbVZPPPlanExp" runat="server" Width="90px"></asp:TextBox>
                                                    <asp:Button ID="showCalendarED" runat="server" Class="btnCalendar" onClientClick="return false;"/>--%>
                                                <%--</div>--%>
                                           
                                        </div>

                                 <div id="dvvzppLoginInfo" style="display: none;"><%--class="phoneFieldsHeight"--%>
                                         <div id="Div3" runat="server" class="leftPhoneFields">
                                                <label class="orderLabel">VZ Account: </label>
                                                 <asp:TextBox ID="vzppVendorPW" runat="server" Width="80px"></asp:TextBox>
                                            </div>
                                         <div class="rightPhoneFields">
                                            <label class="orderLabel">VZ Passcode: </label>
                                            <asp:TextBox ID="vzppVendorPin" runat="server" Width="80px"></asp:TextBox>
                                        </div>
                                    </div>
                                ...
                                <div style="height: 190px; Width: 100%;">
                                    ...
                                    <div class="leftPhoneFields" style="height: 100%;">
                                        ...
                                        <div id="dvVendorPin" style="display: block;">
                                        <div class="phoneFieldsHeight" >
                                    ...
                                    <div runat="server" id="newNumberFldsDiv" style="height: 100%; display: none;" 
                                        ...
                                        <div id="newNumberHolderDiv" style="height: 100%; width: 85%; border: 1px solid gray; border-radius: 3px;">
                                            ...
                                            <div id="portNumberDiv" class="newNumberDiv" style="display: none;">
                                                ...
                                                <div class="newNumberRow" id="Div1">
                                                    <div class="lblDiv">
                                                        <label>Account Code</label>
                                                    </div>
                                                    <div class="fldDiv">
                ...
                <ContentTemplate>
                    <div>
                        ...
                        <div id="selectAdminTaskDiv">
                            <fieldset style="margin-top: 0px;">
                                ...
                                <asp:RadioButtonList ID="adminTasksRadiolist" runat="server" TextAlign="Right">
                                   ...
                                   <asp:ListItem Text="Back-End Converted to Sprint" Value="convertedToSprint"></asp:ListItem>
                        ...
                        <div>&nbsp;</div>
                         ...
                         <div id="divConvertSprint" runat="server" visible="false" style="overflow: auto; min-height: 0%; width:100%">
                         <label >   Customer ID #:</label>
                                     <asp:TextBox ID="txtSprintCustId" runat="server" ></asp:TextBox>
                                     
                                     <asp:Button ID="btnSubmit" runat="server" Text="Submit" style="float: right;" />
                         </div>
...
//            ifFormat: "%Y-%m-%d",
        ...
        Calendar.setup(
       {
           inputField: "tbVZPPPlanStart",
           //            ifFormat: "%Y-%m-%d",
           button: "showCalendarSD",
           // date: new Date(yr, mo, dy),
           onSelect: function () {
               this.eventName = "sd";
               dateChanged(this);
    ...
    //    Calendar.setup(
    //  {
    //      inputField: "tbVZPPPlanExp",
    //      //            ifFormat: "%Y-%m-%d",
    //      button: "showCalendarED",
    //      // date: new Date(yr, mo, dy),
    //      onSelect: function () {
    //          this.eventName = "ed";
    //          dateChanged(this);
