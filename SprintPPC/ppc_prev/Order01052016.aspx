    ...
    <script type="text/javascript">
        ...
        var newNumberForm = {
            ...
            toggleCarrier: function (self) {
                ...
                if (carrier == 'verizon') {
                    self.showVerizon();
                } else if ((carrier == 'page plus') || (carrier == 'all talk')) {
                    self.showPagePlus();
                }
            },
...
<%--                <asp:Button ID="statusBtn" runat="server" Height="12px" 
                ...
                <asp:LinkButton ID="statusLkBn" runat="server" Font-Size="X-Small" 
                style="text-decoration: underline">Refresh</asp:LinkButton>
            </span>
