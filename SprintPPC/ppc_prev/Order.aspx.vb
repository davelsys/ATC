...
Partial Class Order
    ...
    Private Sub UpdateOrder()
        ...
        If carrierName.SelectedValue.ToLower = "sprint" Then
            sql.Append("exec SprintCheckMDN @orderid, @cell_number ")
        End If
    ...
    Private Sub ChargeOrder()
        ...
        Else
            ...
            ElseIf varCarrierName.ToLower = "sprint" Then
                UpdateSprintPayment(PlanId, charge.TransactionId)
            End If
    ...
    Private Sub UpdateSprintPayment(ByVal planid As Integer, ByVal transid As Integer)  'SG 10/11/16
    ...
    Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        ...
        cmd.Connection.Open()
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "update orders set carrier_name = 'Sprint', statusmsg = 'Will be Converted to Sprint After Payment" + DateTime.Now.ToShortDateString + "' "
        cmd.CommandText = cmd.CommandText & "where cell_num = @mdn  "
