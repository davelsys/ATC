...
Class ConResp
    ...
    Private Sub BindconRespGrid()
        ...
        sql.Append("select conreqid,Processed,ReqType,PON,MDN,ESN,reqStatus,ISNULL(NullIF(RespStatus,''),reqstatus)[RespStatus],isnull(NullIF(RespAckMsg,''),ReqAckMsg)[RespAckMsg],Poll,PollCount,lastpoll ")
