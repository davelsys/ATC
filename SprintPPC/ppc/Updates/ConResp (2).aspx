<%@ Page Title="ConcordResp" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false"
    CodeFile="ConResp.aspx.vb" Inherits="ConResp" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div id="searchPinsPnl" class="searchDivPins" style="margin-bottom: 0; padding: 0; width: 98%;">
        ...
        <div id="pollConcordDiv" runat="server" style="width: 18%">
            <fieldset style="width: 98%; border-right: none">
                <legend>Polling</legend>
                <asp:RadioButtonList ID="pollConcordRadioList" CssClass="noPadding" runat="server"
        ...
        <div id="filterConcordDiv" style="width: 28%;" runat="server">
            <fieldset style="width: 98%; border-right: none">
                <legend>Status</legend>
                <asp:RadioButtonList ID="filterConRadioList" CssClass="noPadding" runat="server" RepeatDirection="Horizontal" AutoPostBack="true">
        ...
        <div id="searchConDiv" style="width: 54%;">
    ...
    <div style="overflow: auto; width: 930px; height: 100%;">
        ...
        <asp:GridView ID="conRespGridview" runat="server" Width="98.3%" AutoGenerateColumns="false"
            Font-Size="11px" ViewStateMode="Enabled" DataKeyNames="conreqid" ClientIDMode="static"
            DataSourceID="conRespGridviewDataSource" AllowPaging="true" PageSize="20" AllowSorting="True">
            <Columns>
                <asp:BoundField DataField="conreqid" HeaderText="conreqid" SortExpression="conreqid" Visible="false" />
        ...
        <asp:SqlDataSource ID="conRespGridviewDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ppcConnectionString %>"
    ...
    <script type="text/javascript">
        ...
        var gcsManager = new atcGlobalCellSearch('globalSearchFld', 'searchPinsBtn', '<%= phoneNumberSearchFld.ClientID %>', '<%= conRespGridview.ClientID%>', '<%= _gcsManager.IsGSOn %>');

        function refreshCellNumFromServer() {

            var pinsTblRows = document.getElementById("conRespGridview").getElementsByTagName("tr");
