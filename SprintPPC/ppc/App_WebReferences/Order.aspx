    ...
    <script type="text/javascript">
        ...
        var planCostLbls = {
            getCost: function ( dropdown ) {
                ...
                var args = "SetCostLblFromServer:" + planId;
        ...
        function TogglePayButton() {
            ...
            if ( radioButtons[0].checked ) {      // Credit card selected
                ...
                if ( !starredPattern.test( ccNumber ) && !regularPattern.test( ccNumber ) ) {
        ...
        function populatePlanEsnAndPins( xml ) {
            ...
            if ( newNumberForm.getCarrier() == 'verizon' ) {
        ...
        var newNumberForm = {
            ...
            init: function () {
                ...
                if ( this.isNewOrder() ) {
                    ...
                    if ( this.getCarrier() == 'page plus' ) {
                        this.showPagePlus();
                        return;
                    } else if ( this.getCarrier() == 'verizon' ) {
            ...
            attachEventHandlers: function () {
                // Remeber this for use in inner scopes.
                var self = this
        ...
        var planDropdowns = {
            toggle: function () {
                var state = document.getElementById( 'cell_number' ).value.length != 10;
                    ...
                    <div>
                        <div id="callDetailDatesDiv" style="margin-bottom: 5px;">
                            <span style="display: inline-block; width: 300px;">
                                <label>From:</label>
                                <asp:Label ID="callDetailFromLbl" runat="server"></asp:Label>
                            </span>

                            <span style="display: inline-block; width: 300px;">
                                <label>To:</label>
                                <asp:Label ID="callDetailToLbl" runat="server"></asp:Label>
                            </span>
                        ...
                        <ContentTemplate>
                            <asp:GridView ID="intlCallsGridView" runat="server" DataSourceID="intlCallSqlDataSource"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="StartBal" DataFormatString="{0:N0}" HtmlEncode="false" HeaderText="Minutes" SortExpression="StartBal" />
                                    <asp:BoundField DataField="EndBal" DataFormatString="{0:c}" HtmlEncode="False" HeaderText="Cost" SortExpression="EndBal" />
                        ...
                        <div id="selectAdminTaskDiv">
                            <fieldset style="margin-top: 0px;">
                                ...
                                <asp:RadioButtonList ID="adminTasksRadiolist" runat="server" TextAlign="Right">
                                    ...
                                    <asp:ListItem Text="Restore" Value="restore"></asp:ListItem>
                                    <asp:ListItem Text="Convert" Value="convert"></asp:ListItem>
                                </asp:RadioButtonList>
                            </fieldset>
                        </div>
