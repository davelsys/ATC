...
Partial Class Order
    ...
    Private varMSID As String = vbNullString
    Private varMSL As String = vbNullString
    Private varSubscrId As String = vbNullString
    ...
    Private Sub PopulateAllPlanDropdowns()
        ...
        If varPaymentsExists = False And varCarrierName.ToLower <> "sprint" Then 'DL 05/21/2020 
        ...
        If Not _isNewOrder Then
            ...
            Try
                If userLevel <> 1 Then 'Admin
                    ...
                    adminTasksRadiolist.Items().RemoveAt(adminTasksRadiolist.Items().IndexOf(adminTasksRadiolist.Items().FindByValue("convertsprint")))
    ...
    Protected Sub moniterChckBox_Load(sender As Object, e As System.EventArgs) Handles moniterChckBox.Load
        ...
        If Not _isNewOrder Then
            ...
            ElseIf varCarrierName.ToLower = "verizon" Or varCarrierName.ToLower = "telco" Or varCarrierName.ToLower = "sprint" Then
    ...
    Protected Sub verRegisterGv_Load(sender As Object, e As System.EventArgs) Handles verRegisterGv.Load
        ...
        If Not _isNewOrder Then
            ...
            ElseIf varCarrierName.ToLower = "sprint" Then
                ...
                sql.Append("MonthExpDate[Expires], p.planname AS [Plan], isnull(MinutesAvailable,0),[MinutesAvailable], ")
                sql.Append(" 0 [Used],1.0  AS Fee, 99 [Available],PlanExpDate [Completed] ")
                sql.Append(" FROM SprintMDN m JOIN Plans p ON m.Planid = p.planid WHERE MID = @CellNum ORDER BY [Renewed] DESC; ")
    ...
    Private Sub GetSprintData()
        ...
        sql.Append("[monitor] , [renew_charge_type], [order_closed], [statusmsg], ")
        ' MDN table
        sql.Append("[Status],'' [Balance], CAST( [PlanExpDate] AS DATE ) AS [PlanExpDate], ")
        sql.Append("CAST( MonthExpDate AS DATE ) AS [MonthExpDate], ")
        sql.Append("right(MSID,10) [MSID], ")
        sql.Append("MSL [MSL], ")
        sql.Append("SubscrId [SubscrId], ")
        sql.Append("MinutesUpdated [LastStatus], [Stacked], [cashstacked],")
        sql.Append("MinutesAvailable [TotalMinutes], ")
        'Plan Table
        sql.Append("[planname], ")
        ...
        sql.Append("FROM [orders] ")
        sql.Append("LEFT JOIN [ppc].[dbo].[SprintMDN] ON [SprintMDN].[MID] = [orders].[cell_num] ")
        sql.Append("LEFT JOIN Plans ON [orders].[plan_id] = [Plans].[planid] ")
        sql.Append("LEFT JOIN [ATCIntl].[dbo].[IntlBalances] ON orders.[intl_pin] = [IntlBalances].[IntlPin] ")
        ...
        If reader.HasRows Then
            ...
            varIntlBalance = ReplaceDBNull(reader.Item("intl_bal"), 0)
            varVerStatusMsg = ReplaceDBNull(reader.Item("statusmsg"), "")
            varMSID = ReplaceDBNull(reader.Item("MSID"), Nothing)
            varMSL = ReplaceDBNull(reader.Item("MSL"), Nothing)
            varSubscrId = ReplaceDBNull(reader.Item("SubscrId"), Nothing)
    ...
    Private Sub SetOrderInfoBar()
        ...
        If varCarrierName.ToLower = "telco" Or varCarrierName.ToLower = "sprint" Then 'SG 01/16/17 removed cash balance from telco as per Mr. Greenberg
        ...
        End If
        If varCarrierName.ToLower = "sprint" Then

            divMinRemaining.Visible = True

            lblTotalMinutes.Text = "Account #:"
            totalMinutesLbl.Visible = True
            totalMinutesLbl.Text = varSubscrId
        
            esnValidLbl.Visible = True
            esnValidLbl.Text = "MSID:"
            esnLbl.Visible = True
            esnLbl.Text = varMSID

            LastValidatelbl.Visible = True
            LastValidatelbl.Text = "MSL:"
            LastValidateDatelbl.Visible = True
            LastValidateDateLbl.Text = varMSL
        End If
    End Sub
    ...
    Private Sub PopulateOrderForm()
        ...
        'If varCarrierName = "sprint" Then
        '    carrierName.Items.FindByText("Geshem").Selected = True
    ...
    Private Sub GetTelcoCdr()
        ...
        sql.Append("0 AS TotalMinutes FROM [Telco].[dbo].CDR_NEW ")
        sql.Append("WHERE [BILLING NUMBER] = @CellNum  AND [CALLTIME] BETWEEN @Start AND @End; ")
        ...
        'Response.Write(sql)
        'Response.Write(varordercellnumber)
        'Response.Write(":")
        'Response.Write(hdnNumOfCallDetailsIntervals.Value)
        'Response.Write(":")
        'Response.Write(callDetailFromIndex.Value)
        'Response.Write(":")
        'Response.Write(callDetailEndIndex.Value)
        'Response.End()
    ...
    Private Function GetPlanCost(ByVal planId As Integer, Optional ByVal isAjax As Boolean = False, Optional ByVal AutoPayPrice As Boolean = False) As Decimal
        ...
        If AutoPayPrice = True And (varCarrierName = "Telco" Or varCarrierName = "Concord" Or varCarrierName.ToLower = "vzpp" Or varCarrierName.ToLower = "sprint") Then
    ...
    Protected Sub executeAdminTasks_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles executeAdminTasks.Click
        ...
        If adminTasksRadiolist.SelectedValue.ToLower = "disconnect" Then 'disconnect verizon
            ...
            ElseIf varCarrierName.ToLower = "sprint" Then
                cmd.CommandText = "Sprint_Disconnect"
            ElseIf varCarrierName.ToLower = "telco" Then
        ...
        ElseIf adminTasksRadiolist.SelectedValue.ToLower = "updatestack" Then 'update stack
            ...
            ElseIf varCarrierName.ToLower = "sprint" Then
                cmd.CommandText = "Sprint_ReleaseStack"
            End If
    ...
    Private Function CreateOrder() As Boolean
        ...
        sql.Append("[intl_pin], [carrier_name], [carrier_pin], [vendor_pin], [monitor] ) ")
        ...
        sql.Append("@intl_pin, @carrier_name, @carrierpin, @vendor_pin, @monitor ); ")
    ...
    Private Function SubmitChangeSprintEsn() As String
        ...
        cmd.CommandText = "Sprint_ChangeESN"
        cmd.Parameters.Add("@OrderId", SqlDbType.Int).Value = varOrderID
        cmd.Parameters.Add("@MDN", SqlDbType.VarChar).Value = varOrderCellNumber
        cmd.Parameters.Add("@NEWESN", SqlDbType.VarChar).Value = hiddenESN.Value
    ...
    End Function
    Protected Sub orderErrorMessage_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles orderErrorMessage.Load
    ...
    Private Sub UpdateOrder()
        ...
        If carrierName.SelectedValue.ToLower = "page plus" Or carrierName.SelectedValue.ToLower = "vzpp" Then
            ...
            '        End If
            '    End If
        ElseIf carrierName.SelectedValue.ToLower = "verizon" Or carrierName.SelectedValue.ToLower = "telco" Or carrierName.SelectedValue.ToLower = "sprint" Then
    ...
    Private Sub ChargeOrder()
        ...
        Else
            ...
            ElseIf varCarrierName.ToLower = "sprint" And (monthlyPlanDropdown.SelectedValue > 0 Or cashBalanceDropdown.SelectedValue > 0) Then
    ...
    Private Sub UpdateSprintMdn(ByVal planid As Integer, ByVal transid As Integer)  'SG 10/11/16
        ...
        cmd.CommandText = "Sprint_AllocatePayment"
        cmd.Parameters.Add("@orderid", SqlDbType.Int).Value = varOrderID
        cmd.Parameters.Add("@cellnum", SqlDbType.VarChar).Value = varOrderCellNumber
        cmd.Parameters.AddWithValue("@planid", planid)
        cmd.Parameters.Add("@npazip", SqlDbType.VarChar).Value = hiddenZip.Value
    ...
    Protected Sub statusLkBn_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles statusLkBn.Click
        ...
        ElseIf varCarrierName.ToLower = "sprint" Then
            ...
            cmd.CommandText = "SprintRunRefresh"
            cmd.Parameters.Add("@mid", SqlDbType.VarChar).Value = varOrderCellNumber
    ...
    Protected Sub refundtransgridview_RowDataBound(ByVal sender As Object, ByVal e As GridViewRowEventArgs) Handles refundtransgridview.RowDataBound
