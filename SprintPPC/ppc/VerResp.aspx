<%@ Page Title="VerResp" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false"
    CodeFile="verResp.aspx.vb" Inherits="Ver2" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
   ...
   <div id="pollVerDiv" runat="server" style="width:18%"> 
            <fieldset style="width:98%; border-right: none">
                <legend>Polling</legend>
                <asp:RadioButtonList ID="pollVerRadioList" CssClass="noPadding" runat="server"
    ...
    <div id="filterVerDiv" style="width: 28%;" runat="server">
            <fieldset style="width:98%; border-right: none">
                <legend>Status</legend>
                <asp:RadioButtonList ID="filterVerRadioList" CssClass="noPadding" runat="server"
                    RepeatDirection="Horizontal" AutoPostBack="true">
         ...
         <div id="searchVerDiv" style="width: 54%;">
    ...
    <div style="overflow: auto; width: 930px; height: 100%;">
        ...
        <asp:GridView ID="verRespGridview" runat="server" Width="98.3%" AutoGenerateColumns="false"
            Font-Size="11px" ViewStateMode="Enabled" DataKeyNames="verid" ClientIDMode="static"
            DataSourceID="verRespGridviewDataSource" AllowPaging="true" PageSize="20" AllowSorting="True">
            <Columns>   
                <asp:BoundField DataField="verid" HeaderText="verid" SortExpression="verid" Visible="false" />
        ...
        <asp:SqlDataSource ID="verRespGridviewDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ppcConnectionString %>"
    ...
    <script type="text/javascript">
        ...
        var gcsManager = new atcGlobalCellSearch('globalSearchFld', 'searchPinsBtn', '<%= phoneNumberSearchFld.ClientID %>', '<%= VerRespGridview.ClientID %>', '<%= _gcsManager.IsGSOn %>');

        function refreshCellNumFromServer() {

            var pinsTblRows = document.getElementById("verRespGridview").getElementsByTagName("tr");
