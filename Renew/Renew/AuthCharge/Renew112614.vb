...
Module Renew
    ...
    Sub Main(ByVal args() As String)
        ...
        cmdstr += "case when p1.planid is not null then p1.monthly_cost else p2.plan_cost end [plancost], "
        ...
        cmdstr += "join customers c on r.order_id = c.customer_id "
        ...
        While rdr.Read()
            ...
            If carrier.ToLower() = "all talk" And (cc.hasCharged Or agt.hasCharged) Then
                ...
                Dim atc_renew_sp As New SqlCommand("exec ATC_Assign_Pin", conat)
                Try
            ...
            If carrier.ToLower() = "Verizon" And (cc.hasCharged Or agt.hasCharged) Then
                ...
                Dim ver_renew_sp As New SqlCommand("exec Ver_Assign_Payment", conat)
                Try
                    If agt.hasCharged Then
                        ver_renew_sp.Parameters.Add("@cellnum", SqlDbType.VarChar).Value = agt.CellNumber
                        ver_renew_sp.Parameters.Add("@planname", SqlDbType.Int).Value = agt.MonthlyPlanId
                    ...
                    ElseIf cc.hasCharged Then
                        ...
                        ver_renew_sp.Parameters.Add("@planname", SqlDbType.Int).Value = cc.MonthlyPlanId
