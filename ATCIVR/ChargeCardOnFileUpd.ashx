...
Public Class Handler : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Try
            ...
            sqlcmd.Parameters.Add("@carrier", SqlDbType.VarChar, 20).Direction = Data.ParameterDirection.Output
            ...
            Dim carrier As String 
             If Not IsDBNull(sqlcmd.Parameters("@carrier").Value) Then
                carrier= sqlcmd.Parameters("@carrier").Value
            Else
                carrier = ""
            End If
            
            'Dim carrier As String = IsDBNull(sqlcmd.Parameters("@carrier").Value)
          ...
          ' End If
            ...
            Try
                ...
                LOG.WriteLog("Charge Card On File: carrier- " + carrier + ":Charged- " + ccCharge.hasCharged.ToString())
                ...
                If ccCharge.hasCharged Then
                    ...
                    Try
                     '
                     'Replaced with IVRNewPayment DL 042920
                     '
                     '   Dim PlanId As Integer
                        
                     '  If ccCharge.MonthlyPlanId > 0 Then
                     '      PlanId = ccCharge.MonthlyPlanId
                     '  ElseIf ccCharge.CashPlanId > 0 Then
                     '       PlanId = ccCharge.CashPlanId
                     '    End If

                     '  If carrier.ToLower = "telco" Then
                            
                        
                     '       sqlcmd2.CommandText = "[Telco_AssignPayment]"
                     '       sqlcmd2.CommandType = CommandType.StoredProcedure
                     '       sqlcmd2.Parameters.Add("@cellnum ", SqlDbType.VarChar, 50).Value = ccCharge.CellNumber
                     '       sqlcmd2.Parameters.Add("@planid ", SqlDbType.Int).Value = PlanId
                     '       sqlcmd2.Parameters.Add("@transid ", SqlDbType.Int).Value = ccCharge.TransactionId
                     '       sqlcmd2.Parameters.Add("@earlyrenew ", SqlDbType.Bit).Value = 0
                    
                     '        sqlcmd2.ExecuteNonQuery()
                     '        LOG.WriteLog("Charge Card On File: [Telco_AssignPayment]: " + ccCharge.CellNumber + ":" + PlanId.ToString() + ":" + ccCharge.TransactionId.ToString())
                     '       ' sqlcon2.Close()
                     ...
                     '       LOG.WriteLog("Charge Card On File: [IVR_EarlyRenewal]: " + ccCharge.CellNumber)
                        
                     '       sqlcmd2.Connection.Close()
                     '       ElseIf carrier.ToLower = "concord" Then
                            
                            
                     '       sqlcmd2.CommandText = "[ConcordNewPayment]"
                     '       sqlcmd2.CommandType = CommandType.StoredProcedure
                     '       sqlcmd2.Parameters.Add("@cellnum ", SqlDbType.VarChar, 50).Value = ccCharge.CellNumber
                     '       sqlcmd2.Parameters.Add("@planid ", SqlDbType.Int).Value = PlanId
                     '       sqlcmd2.Parameters.Add("@transid ", SqlDbType.Int).Value = ccCharge.TransactionId
                     '       sqlcmd2.Parameters.Add("@orderid ", SqlDbType.Int).Value = ccCharge.OrderId
                     '  End If
                     ...
                     ' Snd DL 
                         ...
                         LOG.WriteLog("Charge Card On File: [IVRNewPayment]: " + ccCharge.CellNumber + ":" + ccCharge.MonthlyPlanId.ToString() + ":" +  ccCharge.CashPlanId.ToString()
                         sqlcmd2.ExecuteNonQuery()
