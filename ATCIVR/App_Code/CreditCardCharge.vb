...
Public Class CreditCardCharge
    ...
    Public Sub RunCharge()
        ...
        If custprofid = 0 Then
            ...
            If Not custprofresp.messages(0).code = "I00001" Then
                ...
                If custprofresp.messages(0).code = "E00039" Then
                    ...
                    For index As Integer = 1 To 5  ' Changed to 5 DL 052420
                        WriteTrace("Incrementing Duplicate Profile Id to " + index.ToString)

                        custprof.description = custProfDescription & index.ToString
                        custprofresp = svc1.CreateCustomerProfile(merchant, custprof, svc.ValidationModeEnum.none)

                        If Not custprofresp.messages(0).code = "E00039" Then
                            Exit For
                        End If
                    Next
                    If Not custprofresp.messages(0).code = "I00001" Then
                        ...
                        If custprofresp.messages(0).code = "E00039" Then
                            varAuthMsg = "Duplicate Customer " + custprofresp.customerProfileId.ToString()
                        Else
                            varAuthMsg = custprofresp.messages(0).text
                        End If
        ...
        If payprofid = 0 Then
            ...
            ' DL  051620 Dim cmd1 As New SqlCommand("update customers set auth_payprof_id = " + payprofid.ToString() + " where customer_id = " + custid.ToString(), con)
            Dim str = "update customers set auth_payprof_id=" + payprofid.ToString()
            str = str + ",cc_last_four=" + cclastfour
            str = str + ",cc_expiration_date='" + "20" + Right(varCCExpiration, 2) + "-" + Left(varCCExpiration, 2) + "'"
            str = str + " where customer_id = " + custid.ToString()
